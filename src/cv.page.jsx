...
export default function Cv() {
  return (
    <div class="space-y-8">
      ...
      <div class="bg-[#3a0159] p-8 rounded-[2.5rem] border border-purple-100">
        ...
        <p class="mt-6 text-sm text-white italic">
        ...
        <div class="bg-orange-100 rounded-[3rem] border border-pink-50 shadow-sm overflow-hidden flex flex-col md:flex-row group">
          ...
          <div class="p-8 md:p-10 md:w-3/5 flex flex-col justify-center">
            ...
            <p class="text-gray-600 mb-5 leading-relaxed text-sm">
              Sistema financiero personal que transforma el registro técnico de
              datos en una herramienta intuitiva para la toma de decisiones.
              Permite el seguimiento riguroso de egresos diarios y su
              vinculación estratégica con metas de ahorro.
            </p>
            <ul class="space-y-3 text-sm text-gray-700">
              <li class="flex items-start gap-2">
                <span class="text-pink-400 mt-0.5">✦</span>
                <span>
                  <strong>Centralización de Datos:</strong>{" "}
                  Registro estructurado con persistencia en tiempo real.
                </span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-pink-400 mt-0.5">✦</span>
                <span>
                  <strong>Vinculación de Metas:</strong>{" "}
                  Asociación de egresos a objetivos para visualizar el avance.
                </span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-pink-400 mt-0.5">✦</span>
                <span>
                  ...
                  Historiales agrupados por días o semanas para identificar
                  patrones de consumo.
                </span>
              </li>
            </ul>
        ...
        <div class="bg-blue-100 rounded-[3rem] border border-pink-50 shadow-sm overflow-hidden flex flex-col md:flex-row-reverse group">
          ...
          <div class="p-8 md:p-10 md:w-3/5 flex flex-col justify-center">
            ...
            <p class="text-gray-500 italic text-sm mb-4 border-l-4 border-purple-200 pl-3">
              "La mente no es un libro que pueda abrirse a voluntad y examinarse
              a placer." Pero tus notas, sí 😉
            </p>
            <p class="text-gray-600 mb-5 leading-relaxed text-sm">
              Un widget ligero de notas de escritorio diseñado con una interfaz
              limpia y minimalista, ideal para organizar ideas sin depender de
            ...
            <ul class="space-y-3 text-sm text-gray-700">
              <li class="flex items-start gap-2">
                ...
                <span>
                  Soporte para múltiples notas con creación, edición y
                  eliminación desde el widget.
                </span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-purple-400 mt-0.5">✦</span>
                <span>
                  Almacenamiento persistente usando <em>XDG Base Directory</em>
                  {" "}
                  para facilitar el respaldo.
                </span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-purple-400 mt-0.5">✦</span>
                <span>
                  Totalmente ligero y rápido, sin dependencias pesadas.
                </span>
              </li>
            </ul>
          </div>
