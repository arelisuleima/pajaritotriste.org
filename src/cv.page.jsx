  ...
  return (
    <main class>
      <section class="cv-intro">
        ...
        <p>
          ¡Hola! Soy{" "}
          <strong>Areli Arias</strong>, desarrolladora con experiencia en
          <strong>Oracle, PeopleSoft, SQL y desarrollo web</strong>. Me apasiona
          crear soluciones eficientes, automatizar procesos y aprender
