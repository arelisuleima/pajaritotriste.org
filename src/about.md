...
<section class="prose prose-invert max-w-none">
  <h2 class="text-3xl font-bold text-purple-950 mb-4">
    🪽 Notas de desarrollo, ideas y vuelos fallidos
  </h2>

<p class="text-white leading-relaxed">
    Bienvenido/a </span>.
    Soy <strong class="text-purple-950 italic">Pajarito Triste</strong>, y este espacio es mi <strong>bitácora personal</strong> donde registro lo que aprendo, construyo y lo que me apasiona mientras sigo el vuelo del desarrollo.
